...
struct Voxel
{
    ...
    constexpr static std::array<VkVertexInputAttributeDescription, 4> getAttributeDescriptions(void)
    {
        constexpr std::array<VkVertexInputAttributeDescription, 4> attributeDescriptions = {{
            ...
            VkVertexInputAttributeDescription{
                ...
                .offset = offsetof(Voxel, texAtlas),
            }
        }};
...
struct std::hash<Voxel>
{
	size_t operator()(Voxel const &vertex) const noexcept
	{
		return (
            ...
            (hash<glm::vec4>()(vertex.texAtlas) << 1
        );
	}
};
